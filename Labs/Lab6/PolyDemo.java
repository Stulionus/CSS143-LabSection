	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 4) ) {
				case 0:		retVal = new FractalFlake(15 ,11,x,y);
							break;
				case 1:		retVal = new FractalFlake( 15,6,x,y);
							break;
				case 2:		retVal = new FractalFlake( 15,7,x,y);
							break;
				case 3: 	retVal = new FractalFlake( 15,12,x,y);
							break;
			}
