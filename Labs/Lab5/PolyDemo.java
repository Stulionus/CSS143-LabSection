	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 4) ) {
				case 0: 	retVal= new Circle(121,65,43);//new Square( x, y, getRandInt(), getRandInt() );
							break;
				case 1: 	retVal = new Square( 0,0,5,5 );//Cube( x, y, getRandInt(), getRandInt(), getRandInt() );
							break;
				case 2: 	retVal = new Square( 5,54,5,12 );
							break;
				case 3: 	retVal = new Square( 0,0,5,5 );//new Circle( x,y,getRandInt() );////new Cylinder( x,y, getRandInt(), getRandInt() );
							break;				
			}
